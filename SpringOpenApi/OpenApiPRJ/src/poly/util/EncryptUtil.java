...
public class EncryptUtil {
	 ...
	 * 가능함. 따라서, 암호화할 때 암호화되는 값에 추가적인 문자열을 붙여서 함께 암호화를 진행함
	 */
	...
	/**
	 * AES128 CBC 암호화 함수 128은 암호화 키 길이를 의미함 128비트는 = 16바이트(1바이트 = 8비트 * 16 = 128)
	 **/
	...
	/*
	 * AES128 CBC 복호화 함수 128은 암호화 키 길이를 의미함
	 */
