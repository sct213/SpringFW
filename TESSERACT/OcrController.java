...
public class OcrController {
	...
	// 업로드되는 파일이 저장되는 기본폴더 설정 
	final private String FILE_UPLOAD_SAVE_PATH = "/Users/dead_line/DEV/upload";
	...
	public String getReadforImageText(HttpServletRequest request, HttpServletResponse response, ModelMap model,
		...
		if(ext.equals("jpeg") || ext.equals("jpg") || ext.equals("gif") || ext.equals("png")) {
			...
			// 정상적으로 값이 생성되었는지 로그 찍어 확인
			log.info("ext : " + ext);
			log.info("saveFileName : " + saveFileName);
			log.info("saveFilePath : " + saveFilePath);
			log.info("fulllFileInfo : " + fullFileInfo);
